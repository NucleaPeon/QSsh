...
public:
    ...
    void setupUi(QDialog *QSsh__SshKeyCreationDialog)
    {
        ...
        QSsh__SshKeyCreationDialog->resize(295, 223);
    ...
    {
        QSsh__SshKeyCreationDialog->setWindowTitle(QApplication::translate("QSsh::SshKeyCreationDialog", "SSH Key Configuration", 0));
        groupBox->setTitle(QApplication::translate("QSsh::SshKeyCreationDialog", "Options", 0));
        keyAlgo->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "Key algorithm:", 0));
        rsa->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "&RSA", 0));
        dsa->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "&DSA", 0));
        keySize->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "Key &size:", 0));
        privateKeyFileLabel->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "Private key file:", 0));
        privateKeyFileValueLabel->setText(QString());
        privateKeyFileButton->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "Browse...", 0));
        label->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "Public key file:", 0));
        publicKeyFileLabel->setText(QString());
        generateButton->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "&Generate And Save Key Pair", 0));
        closeButton->setText(QApplication::translate("QSsh::SshKeyCreationDialog", "&Cancel", 0));
    } // retranslateUi
